...
use AmeliaBooking\Application\Commands\Test;
use AmeliaBooking\Application\Commands\User;
use AmeliaBooking\Application\Commands\Zoom;
use AmeliaBooking\Application\Commands\WhatsNew;
...
$entries['command.bus'] = function ($c) {
    return League\Tactician\Setup\QuickStart::create(
        [
            // Test
            Test\TestCommand::class                                   => new Test\TestCommandHandler($c),
            // Activation
            ...
            Bookable\Package\AddPackageCustomerCommand::class         => new Bookable\Package\AddPackageCustomerCommandHandler($c),
            Bookable\Package\UpdatePackagesPositionsCommand::class    => new Bookable\Package\UpdatePackagesPositionsCommandHandler($c),
            // Bookable/Resource
            Bookable\Resource\AddResourceCommand::class               => new Bookable\Resource\AddResourceCommandHandler($c),
            Bookable\Resource\UpdateResourceCommand::class            => new Bookable\Resource\UpdateResourceCommandHandler($c),
            Bookable\Resource\UpdateResourceStatusCommand::class      => new Bookable\Resource\UpdateResourceStatusCommandHandler($c),
            Bookable\Resource\DeleteResourceCommand::class            => new Bookable\Resource\DeleteResourceCommandHandler($c),
            Bookable\Resource\GetResourcesCommand::class              => new Bookable\Resource\GetResourcesCommandHandler($c),
            // Booking/Event
            ...
            Notification\SendTestWhatsAppCommand::class               => new Notification\SendTestWhatsAppCommandHandler($c),
            ...
            Notification\WhatsAppWebhookRegisterCommand::class        => new Notification\WhatsAppWebhookRegisterCommandHandler($c),
            Notification\WhatsAppWebhookCommand::class                => new Notification\WhatsAppWebhookCommandHandler($c),
            // Payment
            ...
            Payment\RefundPaymentCommand::class                       => new Payment\RefundPaymentCommandHandler($c),
            Payment\GetTransactionAmountCommand::class                => new Payment\GetTransactionAmountCommandHandler($c),
            Payment\CalculatePaymentAmountCommand::class              => new Payment\CalculatePaymentAmountCommandHandler($c),
            ...
            Payment\PaymentCallbackCommand::class                     => new Payment\PaymentCallbackCommandHandler($c),
            Payment\PaymentLinkCommand::class                         => new Payment\PaymentLinkCommandHandler($c),
            // Report
            ...
            // What's new
            WhatsNew\GetWhatsNewCommand::class                        => new AmeliaBooking\Application\Commands\WhatsNew\GetWhatsNewCommandHandler($c),
        ]
    );
};
