...
class PaymentIntentService extends \AmeliaStripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\PaymentIntent>
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\PaymentIntent
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\SearchResult<\AmeliaStripe\PaymentIntent>
     */
