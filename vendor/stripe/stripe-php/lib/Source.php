 ...
 * @property \AmeliaStripe\StripeObject $ach_credit_transfer
 * @property \AmeliaStripe\StripeObject $ach_debit
 ...
 * @property \AmeliaStripe\StripeObject $code_verification
 ...
 * @property \AmeliaStripe\StripeObject $multibanco
 * @property null|\AmeliaStripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \AmeliaStripe\StripeObject $p24
 * @property \AmeliaStripe\StripeObject $receiver
 * @property \AmeliaStripe\StripeObject $redirect
 * @property \AmeliaStripe\StripeObject $sepa_credit_transfer
 * @property \AmeliaStripe\StripeObject $sepa_debit
 * @property \AmeliaStripe\StripeObject $sofort
 * @property \AmeliaStripe\StripeObject $source_order
 ...
 * @property \AmeliaStripe\StripeObject $three_d_secure
 ...
 * @property \AmeliaStripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \AmeliaStripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Source the detached source
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\SourceTransaction> list of SourceTransactions
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Source the verified source
     */
