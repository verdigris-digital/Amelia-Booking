 ...
 * @property null|string|\AmeliaStripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact on your account balance.
 * @property null|string|\AmeliaStripe\Charge $charge ID of the charge that was refunded.
 ...
 * @property string|\AmeliaStripe\BalanceTransaction $failure_balance_transaction If the refund failed, this balance transaction describes the adjustment made on your account balance that reverses the initial balance transaction.
 ...
 * @property \AmeliaStripe\StripeObject $next_action
 * @property null|string|\AmeliaStripe\PaymentIntent $payment_intent ID of the PaymentIntent that was refunded.
 ...
 * @property null|string|\AmeliaStripe\TransferReversal $source_transfer_reversal The transfer reversal that is associated with the refund. Only present if the charge came from another Stripe account. See the Connect documentation for details.
 ...
 * @property null|string|\AmeliaStripe\TransferReversal $transfer_reversal If the accompanying transfer was reversed, the transfer reversal object. Only applicable if the charge was created using the destination parameter.
 */
class Refund extends ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Refund the canceled refund
     */
