 ...
 * @property null|(string|\AmeliaStripe\TaxId)[] $account_tax_ids The account tax IDs associated with the invoice. Only editable when the invoice is a draft.
 ...
 * @property null|string|\AmeliaStripe\StripeObject $application ID of the Connect Application that created the invoice.
 ...
 * @property \AmeliaStripe\StripeObject $automatic_tax
 ...
 * @property null|string|\AmeliaStripe\Charge $charge ID of the latest charge generated for this invoice, if any.
 ...
 * @property null|\AmeliaStripe\StripeObject[] $custom_fields Custom fields displayed on the invoice.
 * @property null|string|\AmeliaStripe\Customer $customer The ID of the customer who will be billed.
 * @property null|\AmeliaStripe\StripeObject $customer_address The customer's address. Until the invoice is finalized, this field will equal <code>customer.address</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\AmeliaStripe\StripeObject $customer_shipping The customer's shipping information. Until the invoice is finalized, this field will equal <code>customer.shipping</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\AmeliaStripe\StripeObject[] $customer_tax_ids The customer's tax IDs. Until the invoice is finalized, this field will contain the same tax IDs as <code>customer.tax_ids</code>. Once the invoice is finalized, this field will no longer be updated.
 * @property null|string|\AmeliaStripe\PaymentMethod $default_payment_method ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription's default payment method, if any, or to the default payment method in the customer's invoice settings.
 * @property null|string|\AmeliaStripe\Account|\AmeliaStripe\BankAccount|\AmeliaStripe\Card|\AmeliaStripe\Source $default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
 * @property \AmeliaStripe\TaxRate[] $default_tax_rates The tax rates applied to this invoice, if any.
 ...
 * @property null|\AmeliaStripe\Discount $discount Describes the current discount applied to this invoice, if there is one. Not populated if there are multiple discounts.
 * @property null|(string|\AmeliaStripe\Discount)[] $discounts The discounts applied to the invoice. Line item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property null|\AmeliaStripe\StripeObject $from_invoice Details of the invoice that was cloned. See the <a href="https://stripe.com/docs/invoicing/invoice-revisions">revision documentation</a> for more details.
 ...
 * @property null|\AmeliaStripe\StripeObject $last_finalization_error The error encountered during the previous attempt to finalize the invoice. This field is cleared when the invoice is successfully finalized.
 * @property null|string|\AmeliaStripe\Invoice $latest_revision The ID of the most recent non-draft revision of this invoice
 * @property \AmeliaStripe\Collection<\AmeliaStripe\InvoiceLineItem> $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
 ...
 * @property null|string|\AmeliaStripe\PaymentIntent $payment_intent The PaymentIntent associated with this invoice. The PaymentIntent is generated when the invoice is finalized, and can then be used to pay the invoice. Note that voiding an invoice will cancel the PaymentIntent.
 * @property \AmeliaStripe\StripeObject $payment_settings
 ...
 * @property null|string|\AmeliaStripe\Quote $quote The quote this invoice was generated from.
 * @property null|string $receipt_number This is the transaction number that appears on email receipts sent for this invoice.
 * @property null|\AmeliaStripe\StripeObject $rendering_options Options for invoice PDF rendering.
 ...
 * @property \AmeliaStripe\StripeObject $status_transitions
 * @property null|string|\AmeliaStripe\Subscription $subscription The subscription that this invoice was prepared for, if any.
 ...
 * @property null|string|\AmeliaStripe\TestHelpers\TestClock $test_clock ID of the test clock this invoice belongs to.
 * @property \AmeliaStripe\StripeObject $threshold_reason
 * @property int $total Total after discounts and taxes.
 * @property null|\AmeliaStripe\StripeObject[] $total_discount_amounts The aggregate amounts calculated per discount across all line items.
 ...
 * @property \AmeliaStripe\StripeObject[] $total_tax_amounts The aggregate amounts calculated per tax rate for all line items.
 * @property null|\AmeliaStripe\StripeObject $transfer_data The account (if any) the payment will be attributed to for tax reporting, and where funds from the payment will be transferred to for the invoice.
...
class Invoice extends ApiResource
{
     ...
     *
     * @return \AmeliaStripe\Invoice the finalized invoice
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Invoice the uncollectible invoice
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Invoice the paid invoice
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Invoice the sent invoice
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Invoice the upcoming invoice
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\InvoiceLineItem> list of InvoiceLineItems
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Invoice the voided invoice
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\SearchResult<Invoice> the invoice search results
     */
     ...
     * @throws \AmeliaStripe\Exception\ApiErrorException if the request fails
     *
     * @return \AmeliaStripe\Collection<\AmeliaStripe\LineItem> the list of line items
     */
